...
# use that parameter to set custom Java class as PythonService entry point.
...
# (list) List of Java .jar files to add to the libs so they can be imported and used by the Python code.
...
# (bool) Android logcat only display log for tags specified, by default it display all log
